...
namespace Pathoschild.Stardew.DataLayers.Layers.Coverage
{
    ...
    internal class ScarecrowLayer : BaseLayer
    {
        ...
        *********/
        ...
        public ScarecrowLayer(ITranslationHelper translations, LayerConfig config, ModIntegrations mods, IMonitor monitor)
            : base(translations.Get("scarecrows.name"), config, monitor)
        {
            this.Legend = new[]
            {
