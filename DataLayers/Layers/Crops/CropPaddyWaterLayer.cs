...
namespace Pathoschild.Stardew.DataLayers.Layers.Crops
{
    ...
    internal class CropPaddyWaterLayer : BaseLayer
    {
        ...
        *********/
        ...
        public CropPaddyWaterLayer(ITranslationHelper translations, LayerConfig config, IMonitor monitor)
            : base(translations.Get("crop-paddy-water.name"), config, monitor)
        {
            this.Legend = new[]
            {
