...
namespace Pathoschild.Stardew.Automate.Framework
{
    ...
    internal class StorageManager : IStorage
    {
        ...
        ****/
        ...
        public bool TryGetIngredient(Func<ITrackedStack, bool> predicate, int count, out Consumable consumable)
        {
        ...
        /// <param name="consumable">The matching consumables.</param>
        /// <returns>Returns whether the requirement is met.</returns>
        public bool TryGetIngredient(int id, int count, out Consumable consumable)
        {
        ...
        /// <returns>Returns whether the requirement is met.</returns>
        public bool TryGetIngredient(Recipe[] recipes, out Consumable consumable, out Recipe recipe)
        {
        ...
        ****/
        ...
        {
            if (this.TryGetIngredient(predicate, count, out Consumable requirement))
            {
                requirement.Reduce();
                return true;
            }
