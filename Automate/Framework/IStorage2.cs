...
namespace Pathoschild.Stardew.Automate.Framework
{
    ...
    internal interface IStorage
    {
        ...
        ****/
        ...
        bool TryGetIngredient(Func<ITrackedStack, bool> predicate, int count, out Consumable consumable);
        ...
        /// <param name="consumable">The matching consumables.</param>
        /// <returns>Returns whether the requirement is met.</returns>
        bool TryGetIngredient(int id, int count, out Consumable consumable);
        ...
        /// <returns>Returns whether the requirement is met.</returns>
        bool TryGetIngredient(Recipe[] recipes, out Consumable consumable, out Recipe recipe);
