namespace Pathoschild.Stardew.Automate.Framework.Models
{
    ...
    internal class ModCompatibilityConfig
    {
        ...
        *********/
        ...
        /// <summary>Whether to transfer seeds into Junimo huts. If true, Junimo huts will accept seeds from connected chests. Does nothing without Better Junimos mod compatibility.</summary>
        public bool BetterJunimosTransferSeedsToJunimoHuts { get; set; } = false;

        /// <summary>Whether to transfer fertilizers into Junimo huts. If true, Junimo huts will accept fertilizers from connected chests. Does nothing without Better Junimos mod compatibility.</summary>
