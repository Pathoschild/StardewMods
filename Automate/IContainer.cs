...
public interface IContainer : IAutomatable, IEnumerable<ITrackedStack>
{
    ...
    *********/
    ...
    /// <returns>If the pipe has no matching item, returns <c>null</c>. Otherwise, returns a tracked item stack, which may have fewer items than requested if no more were found.</returns>
