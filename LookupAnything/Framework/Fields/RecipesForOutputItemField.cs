...
{
    /// <summary>A metadata field which shows a list of recipes that create an item.</summary>
    internal class RecipesForOutputItemField : GenericField
    {
        /*********
        ** Fields
        *********/
        ...
        *********/
        ...
        public RecipesForOutputItemField(GameHelper gameHelper, string label, RecipeModel[] recipes)
        ...
        public override Vector2? DrawValue(SpriteBatch spriteBatch, SpriteFont font, Vector2 position, float wrapWidth)
        {
            ...
            foreach (Entry entry in this.Recipes)
            {
                ...
                {
                    spriteBatch.DrawTextBlock(font, $"{entry.Type}:", position + new Vector2(0, topOffset + 5), wrapWidth, Color.Black);
