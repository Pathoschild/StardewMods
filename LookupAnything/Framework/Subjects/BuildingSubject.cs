    ...
    internal class BuildingSubject : BaseSubject
    {
        ...
        *********/
        ...
        public BuildingSubject(SubjectFactory codex, GameHelper gameHelper, Building building, Rectangle sourceRectangle)
            : base(codex, gameHelper, building.buildingType.Value, null, I18n.Type_Building())
        {
            // init
        ...
        public override IEnumerable<ICustomField> GetData()
        {
            ...
            if (owner != null)
                yield return new LinkField(this.GameHelper, I18n.Building_Owner(), owner.Name, () => this.Codex.GetPlayer(owner));
            ...
            if (built && building is Stable stable)
            {
                ...
                if (horse != null)
                {
                    yield return new LinkField(this.GameHelper, I18n.Building_Horse(), horse.Name, () => this.Codex.GetCharacter(horse));
