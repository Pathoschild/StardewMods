                ...
                switch (building)
                {
                    ...
                    case FishPond pond:
                        ...
                        else
                        {
                            ...
                            yield return new FishPondDropsField(this.Codex, this.GameHelper, I18n.Building_FishPond_Drops(), pond.currentOccupants.Value, pondData, preface: I18n.Building_FishPond_Drops_Preface(chance: chanceOfAnyDrop.ToString()));
