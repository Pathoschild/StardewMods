...
namespace ContentPatcher.Framework.Patchers
{
    ...
    internal class EditImagePatch : IPatch
    {
        ...
        *********/
        ...
        /// <summary>Determines if loaded or not.</summary>
        ...
        *********/
        ...
        /// <param name="enabled">Determines if area should be edited.</param>
        /// <param name="monitor">Encapsulates monitoring and logging.</param>
        /// <param name="assetLoader">Handles the logic around loading assets from content packs.</param>
        public EditImagePatch(IContentPack contentPack, string assetName, string locale, string fromLocalAsset, Rectangle fromArea, Rectangle toArea, bool enabled, IMonitor monitor, AssetLoader assetLoader)
        {
            // init
