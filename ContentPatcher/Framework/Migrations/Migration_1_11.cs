    ...
    internal class Migration_1_11 : BaseMigration
    {
        ...
        *********/
        ...
        public override bool TryMigrate(ILexToken lexToken, out string error)
        {
            ...
            if (lexToken is LexTokenToken token && token.Name.Equals("Random", StringComparison.InvariantCultureIgnoreCase) && token.InputArgs != null && token.InputArgs.ToString().Contains("|"))
            {
