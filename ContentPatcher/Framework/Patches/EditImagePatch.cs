...
namespace ContentPatcher.Framework.Patches
{
    ...
    internal class EditImagePatch : Patch
    {
        ...
        *********/
        ...
        public EditImagePatch(string logName, ManagedContentPack contentPack, ITokenString assetName, IEnumerable<Condition> conditions, ITokenString fromAsset, TokenRectangle fromArea, TokenRectangle toArea, PatchMode patchMode, Color? blendColor, IMonitor monitor, Func<string, string> normalizeAssetName)
        ...
        public override void Edit<T>(IAssetData asset)
        {
            ...
            if (this.BlendColor.HasValue)
            {
                ...
                editor.PatchImage(colorBlendedSource, sourceArea, targetArea, this.PatchMode);
            }
            else
            {
                // apply source image
