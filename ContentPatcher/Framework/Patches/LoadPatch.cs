...
namespace ContentPatcher.Framework.Patches
{
    ...
    internal class LoadPatch : Patch
    {
        ...
        *********/
        ...
        public LoadPatch(string logName, ManagedContentPack contentPack, IManagedTokenString assetName, IEnumerable<Condition> conditions, IManagedTokenString localAsset, Func<string, string> normaliseAssetName)
