...
information to the screen and unlocks the game's built-in debug mode.
...
2. Unlock the game's built-in debug hotkeys:
   ...
   `F10`  | **Broken.** Launches a multiplayer server.
